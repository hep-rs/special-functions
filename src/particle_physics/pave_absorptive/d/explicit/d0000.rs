...
pub(crate) fn d0000(param: &Parameters) -> f64 {
                    ...
                    * (param.s1 * param.s12
                    ...
                    + param.s1
                        * (param.m3_2 * (param.s12 + param.s2 - param.s1)
                            + param.s1 * param.s3
                            + param.m2_2 * (-2. * param.m3_2 + param.s23 + param.s4 - param.s1)
                            - param.s2 * param.s4
                            - param.s12 * param.s23)
                    + param.m0_2
                        * (param.m3_2 * param.s1
                    ...
                    * (param.s1 * param.s12
                    ...
                    + param.s12
                        * (param.m3_2 * (param.s1 + param.s2 - param.s12)
                            + param.s12 * param.s23
                            + param.m1_2 * (-2. * param.m3_2 + param.s3 + param.s4 - param.s12)
                            - param.s2 * param.s4
                            - param.s1 * param.s3)
                    + param.m0_2
            ...
            * log_diff(
                param.m2_2
                    * (param.s1 * param.s2
                    ...
                    + param.s2
                        * (param.m3_2 * (param.s1 + param.s12 - param.s2)
                            + param.m0_2 * (-2. * param.m3_2 + param.s23 + param.s3 - param.s2)
                            + param.s2 * param.s4
                            - param.s1 * param.s3
                            - param.s12 * param.s23)
