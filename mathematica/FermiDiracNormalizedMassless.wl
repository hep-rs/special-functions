...
f[x_] = -PolyLog[3, -Exp[x]] / Zeta[3];

Print["Approximating normalized massless Fermi-Dirac statistic"];
output = OpenWrite[FileNameJoin[{
  Directory[],
  "../src/particle_physics/statistics/fermi_dirac_normalized_massless.rs"
  }]];
