...
(* ------------------------------------------------------------------------------ *)
(* 0th Derivative *)
Print["Approximating Fermi-Dirac statistic (0th derivative)."];
...
(* ------------------------------------------------------------------------------ *)
(* 1st Derivative *)
Print["Approximating Fermi-Dirac statistic (1st derivative)."];
output = OpenWrite[FileNameJoin[{
  Directory[],
  "../src/particle_statistics/fermi_dirac_deriv.rs"
  }]];
